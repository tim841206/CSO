...
CREATE TABLE `ITMMAS` (
  ...
  `pricurdate` date NOT NULL,
  `pri_his1` int(11) NOT NULL,
  `prihis1d` date NOT NULL,
  `pri_his2` int(11) NOT NULL,
  `prihis2d` date NOT NULL,
  `pri_his3` int(11) NOT NULL,
  `prihis3d` date NOT NULL,
