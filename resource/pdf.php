...
elseif (isset($_GET['PCKLSTNO']) && isset($_GET['INVOICENO'])) { // 列印發票
  $pdf->SetFont('cid0jp', 'B', 20);
...
elseif (isset($_GET['PCKLSTNO'])) { // 重印揀貨單
  $pdf->SetFont('cid0jp', 'B', 20);
  $pdf->Write(0, '揀貨單', '', 0, 'C', true, 0, false, false, 0);
  $pdf->SetFont('cid0jp', '', 12);
  $PCKLSTNO = $_GET['PCKLSTNO'];
...
elseif (isset($_GET['INVOICENO'])) { // 重印發票
  $pdf->SetFont('cid0jp', 'B', 20);
  $pdf->Write(0, '發票', '', 0, 'C', true, 0, false, false, 0);
  $pdf->SetFont('cid0jp', '', 12);
  $INVOICENO = $_GET['INVOICENO'];
